...
class TrialMode {
    ...
    struct DemoSessionData {
        ...
        init(
            id: String, description: String, messages: [Message], createdAt: String,
            updatedAt: String, displayMessageCount: Int? = nil
        ) {
            self.id = id
        ...
        return [
            ...
            DemoSessionData(
                ...
                messages: [
                    Message(
                        role: .user,
                        text: "I need you to deploy and turn on my home automation server"),
                    Message(
                        role: .assistant,
                        text:
            ...
            DemoSessionData(
                id: "trial-demo-3",
                description: "Example: Can you transcript a podcast for me (read-only)",
                messages: [
                    Message(
                        role: .user,
                        text:
            ...
            DemoSessionData(
                ...
                messages: [
                    ...
                    Message(
                        role: .assistant,
                        text:
                            "I'll help you break down your expenses. Can you share your main spending categories?"
                    ),
                    Message(
                        role: .user, text: "Rent $2000, groceries $500, transport $300, dining $400"
                    ),
                    Message(
                        role: .assistant,
                        text:
                            "Your dining ($400) seems high compared to groceries ($500). Consider meal prepping to save $150-200/month..."
                    ),
                ],
            ...
            DemoSessionData(
                ...
                messages: [
                    Message(
                        role: .user, text: "Can you review this API endpoint for security issues?"),
                    Message(
                        role: .assistant,
                        text:
                            "I'll review for common security vulnerabilities:\n\n1. Input validation\n2. Authentication/Authorization\n3. SQL injection risks\n4. Rate limiting\n\nPlease share the code..."
                    ),
                ],
            ...
            DemoSessionData(
                ...
                messages: [
                    ...
                    Message(
                        role: .assistant,
                        text:
                            "I'll help you create a competitive analysis. What's your product category and who are you considering?"
                    ),
                ],
            ...
            DemoSessionData(
                ...
                messages: [
                    ...
                    Message(
                        role: .assistant,
                        text:
                            "Here's a comprehensive schedule:\n\n**Every 5,000 miles:**\n- Oil change\n- Tire rotation\n\n**Every 30,000 miles:**\n- Air filter\n- Cabin filter\n- Brake inspection\n\nYour current mileage?"
                    ),
                ],
            ...
            DemoSessionData(
                ...
                messages: [
                    Message(
                        role: .user,
                        text: "I want to build a reusable React component for a data table"),
                    Message(
                        role: .assistant,
                        text:
            ...
            DemoSessionData(
                ...
                messages: [
                    ...
                    Message(
                        role: .assistant,
                        text:
                            "I'll extract action items with owners and deadlines. Please share the notes."
                    ),
                ],
            ...
            DemoSessionData(
                ...
                messages: [
                    ...
                    Message(
                        role: .assistant,
                        text:
                            "I'll help craft a professional follow-up. What's the context and what action do you want from them?"
                    ),
                ],
            ...
            DemoSessionData(
                ...
                messages: [
                    ...
                    Message(
                        role: .assistant,
                        text:
                            "I'll create a comparison table. Please share the plans' details: premium, deductible, out-of-pocket max, and coverage highlights."
                    ),
                ],
            ...
            DemoSessionData(
                ...
                messages: [
                    ...
                    Message(
                        role: .assistant,
                        text:
                            "Let's break down the kitchen renovation process:\n\n1. Set budget\n2. Choose layout\n3. Select appliances\n4. Pick materials\n5. Hire contractors\n\nWhat's your budget range?"
                    ),
                ],
            ...
            DemoSessionData(
                ...
                messages: [
                    ...
                    Message(
                        role: .assistant,
                        text:
                            "I'll help clarify contract language. Please share the specific sections you need explained. Note: This is informational, not legal advice."
                    ),
                ],
            ...
            DemoSessionData(
                ...
                messages: [
                    ...
                    Message(
                        role: .assistant,
                        text:
                            "Let's explore opportunities. What are your skills and interests? What problems frustrate you in your daily work?"
                    ),
                ],
            ...
            DemoSessionData(
                ...
                messages: [
                    Message(
                        role: .user,
                        text: "Help me write a cover letter for software engineer position"),
                    Message(
                        role: .assistant,
                        text:
                            "I'll help craft a compelling cover letter. Tell me:\n\n1. Company name and role\n2. Your relevant experience\n3. Why you're interested\n4. Key achievements\n\nLet's create something that stands out!"
                    ),
                ],
